...
public class Reusable_Actions_Loggers {
    ...
    public static void selectDropDown(WebDriver driver, String xpath, String userValue, ExtentTest logger, String elementName) {
        ...
        try {
            ...
            logger.log(LogStatus.PASS, "Successfully select on element " + elementName);
    ...
    public static void verifyTitle(WebDriver driver, ExtentTest logger, String title) {
        WebDriverWait wait = new WebDriverWait(driver, 10);

        String actualTitle = driver.getTitle();
        if (actualTitle.equals(title)) {
            System.out.println("My title matches");
            logger.log(LogStatus.PASS, "Successfully matches title " + title);
        } else {
            System.out.println("Title doesn't match. Actual title is " + actualTitle);
            logger.log(LogStatus.FAIL, "Unable to match title " + title + " ");
        }
    ...
    public static void verifyStatusOfElement(WebDriver driver, String xpath, Boolean expectedStatus, ExtentTest logger, String ElementName){
        ...
        try{
            ...
            System.out.println("Unable to check status of " + ElementName + e);
        }
